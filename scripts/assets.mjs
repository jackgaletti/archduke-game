...
for(const value of values){
 ...
 const output=`public/cards/${value}.webp`;await sharp(bytes).resize({width:420,withoutEnlargement:true}).webp({quality:90}).toFile(output);
...
console.log('Validated all 16 original PNGs; generated aspect-preserving WebP assets.');
